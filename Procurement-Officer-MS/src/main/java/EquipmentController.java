...
public class EquipmentController {
    ...
    public EquipmentController(EquipmentService equipmentService, VendorService vendorService) {
        this.equipmentService = equipmentService;
    ...
    @PostMapping("/{equipmentId}/assign-to-vendor/{vendorId}")
    public Vendor assignEquipmentToVendor(@PathVariable String equipmentId, @PathVariable String vendorId) {
        return vendorService.addEquipmentToVendor(vendorId, equipmentId);
    }

    @PostMapping("/{equipmentId}/remove-from-vendor/{vendorId}")
    public Vendor removeEquipmentFromVendor(@PathVariable String equipmentId, @PathVariable String vendorId) {
